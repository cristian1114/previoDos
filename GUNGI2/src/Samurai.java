 ...
 *  Samurai Class
 *  <p>
 *  A Samurai is a specific piece of the game
 */
public class Samurai extends Pawn{
     ...
     */
    public Samurai(int xx, int yy, Vector2D rc, int pl_color){
		super(xx,yy,rc, pl_color);
        valueIA = 4;
	}
	public Samurai(int xx, int yy, int rr, int cc, int pl_color){
    	...
    	switch(this.level){
    		...
    		case 2:{
    			...
    			for (BoardPanel e:elements){
    				...
    				else if (e.getRow() == fila_actual-dif*2 && e.getColumn()==columna_actual){
    					int ss = e.getTierSize();
                        switch(ss){
                            case 0: posibles.add(e); break;
                            case 1: 
    				...
    				else if (e.getRow() == fila_actual+dif && (e.getColumn()==columna_actual-1 || e.getColumn()==columna_actual+1)){
    					int ss = e.getTierSize();
                        switch(ss){
                            case 0: posibles.add(e); break;
                            case 1: 
